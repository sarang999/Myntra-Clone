                    ...
                    <div className="inputcontainer">
                        <div>
                            ...
                            <div className="inputdiv">
                                <input className="input1" type="text" value={`+91`} onChange={()=>handleChange()} />
                                <input onChange={(e)=>setMobile(e.target.value)} value={mobile} className="input2" type="text" placeholder="Mobile Number" />
