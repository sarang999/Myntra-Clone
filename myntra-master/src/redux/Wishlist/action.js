...
export const postWishData = (payload) => (dispatch) => {
  ...
  return axios
    .post("https://ecommyntra-fake-server-app.herokuapp.com/wishlist", payload)
    .then((res) => {
...
export const patchWishData = (idx, sizex) => (dispatch) => {
  ...
  return axios
    .patch(`https://ecommyntra-fake-server-app.herokuapp.com/wishlist/${idx}`, {
      selected_size: `${sizex}`,
    })
    .then((res) => {
...
export const deleteWishData = (idx) => (dispatch) => {
  ...
  return axios
    .delete(`https://ecommyntra-fake-server-app.herokuapp.com/wishlist/${idx}`)
    .then((res) => {
...
export const getWishData = (payload) => (dispatch) => {
  ...
  return axios
    .get("https://ecommyntra-fake-server-app.herokuapp.com/wishlist", payload)
    .then((res) => {
