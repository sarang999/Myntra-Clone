    ...
    <div>
      ...
      <div id="container">
        <div id="box1">
          <div id="box1-1">
            <h5>
              <i className="fas fa-percent"></i> Bank Offer
            </h5>
            <p>
              10% Instant Discount with Standard Chartered Credit and Debit
              Cards on a min spend of Rs 3,000. TCA
            </p>
            <h5 className="pink">
          ...
          <div id="box1-2">
            <div id="box1-2-1">
              ...
              <div>
                <h5>
                  <i className="fab fa-google-pay"></i> PHONEPE/GOOGLEPAY/BHIM
                  UPI
                </h5>
              </div>
              <div>
                <h5>
                  <i className="fas fa-wallet"></i> PAYTM/PAYZAPP/WALLETS
                </h5>
              </div>
              <div>
                <h5>
          ...
          <div id="box1-3">
            <div id="box1-3-1">
              <h4>
                <i className="fas fa-gift"></i> Have A Gift Card?
              </h4>
            </div>
            <div id="box1-3-2">
              <p className="pink">Apply Gift Card</p>
            </div>
          </div>
        </div>
        <div>
          <div className="fontBold font14 marginTop20">
            PRICE DETAILS ({bagD.length} Items)
          </div>
          ...
          <Link to="/">
            <div
              className="placeOrderBtn marginTop font14 fontBold cursor"
              onClick={() => {
