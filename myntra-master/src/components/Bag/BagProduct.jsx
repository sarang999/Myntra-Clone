    ...
    <div>
      {bagData.map((e, i) => (
        <div className="pr marginTop">
          <div>
            <img src={e.images.image1} alt=""></img>
          </div>
          <div>
            <p className="fontBold">{e.title}</p>
            <p className="font14">{e.description}</p>
            <div className="gridData">
              <div className="subGridDiv1 marginTop">
                Size:{e.selected_size}▼{" "}
              </div>
            ...
            <div className="price">
              ...
              <p className="off">{e.off_price}</p>
              <p className="disc">{e.discount}% OFF</p>
            </div>
          </div>
