...
export const Productdeatils = () => {
  ...
  const getData = (id) => {
    axios
      .get(
        `https://ecommyntra-fake-server-app.herokuapp.com/mens_product_data/${id}`
      )
      .then((res) => {
        setData(res.data);
        setLoading(false);
  ...
  return loading ? (
    ...
    <Box className={classes.container}>
      <div>
        <p>
          Home/Clothing/{data.gender}'s clothing/
          <span style={{ fontWeight: "bolder" }}>
            {data.categories}/More By {data.brand}
          </span>
        </p>
        ...
        <div className={classes.main}>
          ...
          <div className={classes.flexDivright}>
            <h2>{data.brand}</h2>
            <h3 style={{ color: "grey", fontWeight: "lighter" }}>
              {data.title}
            </h3>
            <p>
              {data.rating} <StarIcon className={classes.star} />
              |13.8k Ratings
            </p>
            <hr />
            <h3>
              ...
              <span style={{ color: "red" }}> (66% OFF)</span>
            </h3>
            <h6 style={{ color: "teal" }}>inclusive of all taxes</h6>

            <h4>
              SELECT <span style={{ color: "red" }}>SIZESIZE CHART </span>
            </h4>
            ...
            {userAuth ? (
              <button
                className={classes.big1}
                onClick={() => {
                  dispatch(postBagData(data));
                  alert("Product is succesfully added to Bag");
                }}
              >
              ...
              <button
                className={classes.big1}
                onClick={() => {
                  alert("Login to Add product to Bag");
                }}
              >
                <ShoppingBagIcon className={classes.bag} />
                ADD TO BAG
            ...
            {userAuth ? (
              <button
                className={classes.big2}
                onClick={() => {
                  dispatch(postWishData(data));
                  alert("Product is succesfully added to Wishlist");
                }}
              >
              ...
              <button
                className={classes.big2}
                onClick={() => {
                  alert("Please Login to add this product to Wishlist");
                }}
              >
                <FavoriteBorderOutlinedIcon
                  style={{ verticalAlign: "text-bottom" }}
            ...
            <p>
              Buy this style and unlock additional 10% off on a selected
              catalogue.
            </p>
          ...
          <div className={classes.similar}>
            <div className={classes.imgs}>
              <img
                ...
                src="https://raw.githubusercontent.com/ShaikRiyazuddin/Myntra_Clone/Sweta_myntra/src/images/pic1.webp"
              />
              <h4>Nayo</h4>
              ...
              <h5>
                ...
                <span style={{ color: "red" }}>(66% 0ff)</span>
              </h5>
            </div>
            ...
            <div className={classes.imgs}>
              <img
                className={classes.imgSize}
                src="https://raw.githubusercontent.com/ShaikRiyazuddin/Myntra_Clone/Sweta_myntra/src/images/pic2.webp"
              />
              <h4>SASSFRAS</h4>
              ...
              <h5>
                ...
                <span style={{ color: "red" }}>(67% 0ff)</span>
              </h5>
            </div>
            ...
            <div className={classes.imgs}>
              <img
                className={classes.imgSize}
                src="https://raw.githubusercontent.com/ShaikRiyazuddin/Myntra_Clone/Sweta_myntra/src/images/pic3.webp"
              />
              <h4>Harpa</h4>
              <p>Floral A line dress</p>
              <h5>
            ...
            <div className={classes.imgs}>
              <img
                className={classes.imgSize}
                src="https://raw.githubusercontent.com/ShaikRiyazuddin/Myntra_Clone/Sweta_myntra/src/images/pic4.webp"
              />
              <h4>PlusS</h4>
              <p>Floral A line dress</p>
              <h5>
            ...
            <div className={classes.imgs}>
              <img
                className={classes.imgSize}
                src="https://github.com/ShaikRiyazuddin/Myntra_Clone/blob/Sweta_myntra/src/images/pic5.jpg?raw=true"
              />
              <h4>Anouk</h4>
              ...
              <h5>
                ...
                <span style={{ color: "red" }}>(60% 0ff)</span>
              </h5>
            </div>
            ...
            <div className={classes.imgs}>
              <img
                className={classes.imgSize}
                src="https://raw.githubusercontent.com/ShaikRiyazuddin/Myntra_Clone/Sweta_myntra/src/images/pic6.webp"
              />
              <h4>U&F</h4>
              ...
              <h5>
                ...
                <span style={{ color: "red" }}>(56% 0ff)</span>
              </h5>
            </div>
          </div>
        </div>
