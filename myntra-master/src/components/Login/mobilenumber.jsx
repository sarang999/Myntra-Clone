        ...
        <div className="logincontainer">
            <div className="logindiv">
                ...
                <div className="inputcontainer">
                    <div>
                        <span className="heading">Login</span><span className="heading2">with</span><span className="heading1">Mobile Number</span><br />
                        <div className="inputdiv">
                            ...
                            <Link to="/entermobilenumber"> <button className='login-useername'>REGISTER NOW</button></Link>
